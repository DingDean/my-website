  ...
  <div id="app">
    ...
    <main>
      ...
      <header class='grid-center'>
        <div v-if='isShown.mainHeader'>
          <h1>哦，嘿，你来了</h1>
          <h1>倍感荣幸</h1>
          <h1>我叫丁科</h1>
          <h1>欢迎来到我的二向箔</h1>
          <p @click="toggle('mainHeader')">Change me for production</p>
        </div>
        <div v-if="!isShown.mainHeader">
          <h1>弹星者与二向箔</h1>
          <p>音乐，终端与命令行。平日的生活简单如斯。</p>
          <p>在一个喧嚣的都市，却活在一个容器里。这容器是自我，是象牙塔。难以分享，难以自察。</p>
          <p>挣扎于内心，却外示以冷静。内外的分割时常让己歇斯底里。</p>
          <p>在每日的独行中，笑过，怒过，哭过，之后重头来过。</p>
          <p>无意或有意，自己正在二维化。</p>
          <p>所以每天唯有音乐，终端与命令行。</p>
          <p>现实塌陷在网络，然投影却比真身更加代表自己。</p>
          <p>我是我自己的弹星者，向宇宙广播着我的存在。这是我力所能及的尝试。</p>
          <p>我将我自己掷入二向箔。</p>
      ...
      <section class='grid-center' id='contact-info'>
        <h1>请让我<span class="togglebtn" @click="toggle('info')">介绍下自己</span>吧。</h1>
